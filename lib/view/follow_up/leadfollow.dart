...
class LeadFollowUp extends StatefulWidget {
  String customerId;
  String branchId;
  LeadFollowUp({
    Key? key,
  ...
  @override
  State<LeadFollowUp> createState() => _LeadFollowUpState();
}

class _LeadFollowUpState extends State<LeadFollowUp> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
          backgroundColor: kSecondaryColor, title: const Text("Add Lead")),
                ...
                Container(
                  ...
                  child: Padding(
                    ...
                    child: DropdownButtonFormField(
                      ...
                      onChanged: (value) {
                        setState(() {
                          selectSpokePeson = value as String?;
                        });
                      },
                  ...
                  children: [
                    ...
                    file != null
                        ? Text(
                            file
                                .toString()
                                .substring(65, file.toString().length),
                            maxLines: 2,
  ...
  Future followupAdd(
    ...
    var request = http.MultipartRequest(
        'POST', Uri.parse('http://sandboxcodeapi.mnscredit.in/api/follow'));
